...
//  DiceRollAR
//
//  Created by McKinney family  on 3/21/19.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //let cube = SCNBox(width: 0.1, height: 0.0, length: 0.1, chamferRadius: 0.01)
        ...
        if let touch = touches.first {
            ...
            if let hitResults = results.first {
               ...
               // Create a new scene
                ...
                //the add dice method check add dice function
//                let diceScene = SCNScene(named: "art.scnassets/diceCollada.scn")!
//
//                if let diceNode = diceScene.rootNode.childNode(withName: "Dice", recursively: true) {
//
...
//                }
    ...
    //MARK: - RollAll and roll dice method
    ...
    //MARK: - Actions Btn methods
    @IBAction func rollAgainBtnWasPressed(_ sender: Any) {
    ...
    @IBAction func removeBtnWasPressed(_ sender: UIBarButtonItem) {
